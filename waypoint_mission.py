...
class Modes:
    ...
    def auto_set_mode(self):
        ...
        try:
            ...
            print("setting auto mission mode failed: %s" % e)
    ...
    def wpPush(self, index, wps):
        ...
        try:
            ...
            print("pushing waypoint failed: %s" % e)
...
class wpMissionCnt:
    ...
    def setWaypoints(self, frame, command, is_current, autocontinue, param1, param2, param3, param4, x_lat, y_long,
                     z_alt):
